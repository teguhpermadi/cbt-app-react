 ...
 * @see app/Http/Controllers/Admin/QuestionSuggestionController.php:21
...
const QuestionSuggestionController = { index, store, update, destroy, approve, reject }

export default QuestionSuggestionController