...
import {
    Home, ArrowLeft, CheckCircle, XCircle, HelpCircle, Trophy, Target,
    TrendingUp, TrendingDown, Users, Medal, BarChart3
} from 'lucide-react';
            ...
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                <div className="flex flex-col gap-2">
                    <Link href="/student/results">
                        <Button variant="ghost" className="w-fit p-0 h-auto text-slate-500 hover:text-slate-800 mb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Main Score Card */}
                    <Card className="md:col-span-2 overflow-hidden border-2 border-primary/20 shadow-md">
                        <div className="absolute top-0 right-0 p-4 opacity-10">
                            <Trophy className="w-32 h-32" />
                        </div>
                        <CardHeader>
                            <CardTitle className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Nilai Akhir Anda</CardTitle>
                        </CardHeader>
