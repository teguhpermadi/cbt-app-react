...
import { Monitor, Settings, ArrowLeft } from 'lucide-react';
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground font-medium">
                            Manage exam settings and monitor results.
                        </p>
                    </div>
                </div>
                    ...
                    <TabsContent value="monitor" className="mt-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Real-time monitoring of student progress and results.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="flex flex-col items-center justify-center py-10 text-center">
                                    ...
                                    <p className="text-muted-foreground max-w-sm mt-2">
                                        Student participation and live results will be displayed here.
                                    </p>
